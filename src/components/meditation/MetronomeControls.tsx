...
export const MetronomeControls: FC<MetronomeControlsProps> = ({
    periodMs,
    min,
    max,
    onPeriodChange,
    ...
    const haloClasses = beatActive ? "opacity-95 scale-110" : "opacity-75 scale-100";
            ...
            <div className="relative rounded-3xl border border-white/45 bg-white/40 px-6 py-5 shadow-[0_24px_65px_-42px_rgba(34,197,94,0.55)] backdrop-blur-xl">
                ...
                <div>
                    <div className="flex items-baseline justify-between text-emerald-900">
                        <div>
                            <p className="text-xs font-semibold uppercase tracking-[0.35em] text-emerald-700/75">
                                Ritmo
                            </p>
                            <p className="mt-1 text-3xl font-semibold leading-none">{bpmValue}</p>
                            <p className="text-[11px] font-semibold uppercase tracking-[0.32em] text-emerald-700/60">
                                BPM
                            </p>
                        </div>
                        <div className="text-right text-[11px] font-semibold uppercase tracking-[0.3em] text-emerald-700/60">
                            <p>mín {bpmRange.minBpm} bpm</p>
                            <p className="mt-1">máx {bpmRange.maxBpm} bpm</p>
                        </div>
                    </div>
                </div>
