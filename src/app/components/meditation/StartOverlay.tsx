      ...
      <div className="max-w-md mx-auto text-center">
        <div className="relative overflow-hidden rounded-[32px] border border-white/35 bg-white/25 p-10 shadow-[0_35px_80px_-40px_rgba(132,204,22,0.35)] backdrop-blur-2xl">
          ...
          >
            ...
            <span className="absolute inset-6 rounded-full border border-white/55 bg-gradient-to-br from-white/70 via-emerald-50/25 to-transparent shadow-[inset_10px_10px_24px_rgba(148,163,184,0.28),inset_-12px_-12px_20px_rgba(255,255,255,0.65)] transition-all duration-500 group-hover:shadow-[inset_12px_12px_28px_rgba(78,205,196,0.28),inset_-14px_-14px_24px_rgba(255,255,255,0.7)]" />
            <span className="relative flex items-center justify-center text-emerald-900">
              <span className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-300/80 via-lime-300/70 to-amber-200/70 text-emerald-900 shadow-inner">
                <Play size={32} className="drop-shadow-[0_6px_10px_rgba(14,116,144,0.25)]" />
              </span>
              <span className="absolute -right-3 -bottom-2 h-10 w-10 rounded-full border border-white/40 bg-white/45 p-1 text-emerald-600 shadow-[0_12px_35px_-18px_rgba(34,197,94,0.55)]">
                <Wind size={20} />
              </span>
            </span>
          </button>
