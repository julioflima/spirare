...
import { updateGeneralContentSchema, updateStructureSchema } from '@/types/database';
  ...
  try {
    ...
    switch (action) {
      case 'updateGeneral': {
        ...
        const database = await MeditationDatabaseService.updateGeneral(validatedData);
      ...
      case 'updateStructure': {
        ...
        const database = await MeditationDatabaseService.updateStructure(validatedData);
